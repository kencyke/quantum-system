...
its action live in `LocalNet.Covariance` / `LocalNet.QuasiLocalAlgebra`. The finite-dimensional
matrix net generated by a `SiteIndexSystem` is packaged in `LocalNet.MatrixModel.Net`.
-/
