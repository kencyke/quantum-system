...
The quasi-local algebra built from a net lives in `LocalNet.QuasiLocal`; covariance actions live in
`LocalNet.Covariance`. The finite-dimensional matrix net generated by a `SiteIndexSystem` is also
packaged in `LocalNet.QuasiLocal`.
-/
