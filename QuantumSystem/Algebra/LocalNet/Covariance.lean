...
C⋆-algebra — is built in `LocalNet.QuasiLocalAlgebra`. The concrete covariance of the matrix net
generated by a `SiteIndexSystem`, together with its inherited action, lives in
`LocalNet.MatrixModel.Covariance`.
-/
